...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println("There are " + gmail.findMailsBetweenDates(new SimpleDateFormat("dd/MM/yyyy").parse("20/12/2022"), new SimpleDateFormat("dd/MM/yyyy").parse("23/12/2022")) + " mails between given dates!");
